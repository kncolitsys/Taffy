...
Documentation is managed [in its own repository](https://github.com/kncolitsys/TaffyDocs) and changes are automatically published once they are merged into the master branch.
...
1. [Fork the project](https://github.com/kncolitsys/Taffy/fork_select)
