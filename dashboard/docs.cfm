				...
				<div class="panel panel-warning">
					...
					<div class="panel-body">
						...
						<p>
							...
							<a href="https://github.com/kncolitsys/Taffy/wiki/So-you-want-to:-use-an-external-bean-factory-like-coldspring-to-completely-manage-resources"
							>Check out the wiki!</a>
						</p>
						<p>
							If all else fails, I recommend starting with <a href="https://github.com/kncolitsys/Taffy/wiki/Getting-Started">Getting Started</a>.
						</p>
					</div>
				</div>
			</cfif>
